    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Registrar un nuevo Curso</h5>
            ...
            <div class="modal-body">
                <form action="Administracion" method="post">
                    <input type="hidden" name="metodo" value="AgregarGrado">
                    <div class="form-group">
                        <label class="col-form-label">Nombre Grado: </label>
                        <input type="text" class="form-control" name="name">
                    </div>
                    <div class="form-group">
                        <label  class="col-form-label">Descripcion Grado: </label>
